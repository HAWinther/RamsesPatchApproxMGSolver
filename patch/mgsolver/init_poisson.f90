subroutine init_poisson
  ...
  allocate(phi_array (1:ncell))
  allocate(phi_old_array (1:ncell))
  allocate(f_array   (1:ncell,1:3))
  ...
  if(mg_solver_active) then
     allocate(phi_mg_array (1:ncell))
     allocate(phi_mg_old_array (1:ncell))
     allocate(f_mg_array (1:ncell,1:3))

     f_mg => f_mg_array
     phi_mg => phi_mg_array
     phi_mg_old => phi_mg_old_array

     phi_mg=0.0D0; f_mg=0.0D0; phi_mg_old=0.0D0
  endif
#else
  allocate(rho (1:ncell))

  ...
  tt1=MPI_WTIME()
   ...
   if(mg_solver_active) then
      if(myid==1) then
        write(*,*) ''
        write(*,*) '============================================'
        write(*,*) 'Modified gravity version is active          '
        write(*,*) '============================================'
        write(*,*) 'Model: ', &
#if defined(SYMMETRON)
                &  'Symmetron'
        write(*,*) 'Range (Mpc/h) lambda_0 : ', lambda_0
        write(*,*) 'Coupling        beta_0 : ', beta_0
        write(*,*) 'SSB Scalefactor   assb : ', assb
#elif defined(FOFR)
                &  'Hu-Sawicku f(R) gravity'
        write(*,*) 'f_R0 : ', fofr0
        write(*,*) 'n    : ', n_fofr
#else
                &  'User-defined model'
        write(*,*) 'Parameters: ', myparam(1:5)
#endif
        write(*,*) '============================================'
        write(*,*) ''
      endif
...
#if defined(MGSOLVER)
           if(mg_solver_active)then
              call make_virtual_fine_dp(phi_mg(1),ilevel)
              do idim=1,ndim
                 call make_virtual_fine_dp(f_mg(1,idim),ilevel)
              end do
           end if
#endif
